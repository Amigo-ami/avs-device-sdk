...
set(PATHTOINPUTFOLDER "" CACHE FILEPATH "KittAi keyword detector inputs path")
...
mark_as_dependent(PATHTOINPUTFOLDER KITTAI_KEY_WORD_DETECTOR)
...
set(PATHTOINPUTFOLDER "" CACHE FILEPATH "Sensory keyword detector inputs path")
...
mark_as_dependent(PATHTOINPUTFOLDER SENSORY_KEY_WORD_DETECTOR)

if(NOT AMAZON_KEY_WORD_DETECTOR AND NOT AMAZONLITE_KEY_WORD_DETECTOR AND NOT KITTAI_KEY_WORD_DETECTOR)
...
if(KITTAI_KEY_WORD_DETECTOR)
    ...
    if(NOT PATHTOINPUTFOLDER)
        message(FATAL_ERROR "Must pass inputs folder path of Kitt.ai KeywordDetector!")
    endif()    
    
    add_definitions(-DKWD)
    add_definitions(-DKWD_KITTAI)
    add_definitions(-DINPUT_MODEFILE="${PATHTOINPUTFOLDER}")
...
if(SENSORY_KEY_WORD_DETECTOR)
    ...
    if(NOT PATHTOINPUTFOLDER)
        message(FATAL_ERROR "Must pass inputs folder path of Sensory KeywordDetector!")
    endif()
